...
const Hero = () => {
    return (
     ...
     <div className='bg-green-600 mx-auto rounded-br-full m-auto'>
         <div className="  text-center flex-col h-custom3 md:h-custom2 xl:h-custom 
          justify-center ">
         <p className='text-green-400 font-bold p-2 md:text-4xl text-2xl xl:pt-32 md:pt-20 pt-20 '> Hi, I'am</p>
